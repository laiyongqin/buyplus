...
class Page{
    ...
    public function __construct($totalRows, $listRows=20, $parameter = array()) {
        ...
        $this->firstRowShow   = $this->listRows * ($this->nowPage - 1) + 1;
        $this->lastRow        = $this->firstRow + $this->listRows;
        $this->lastRow        = ($this->lastRow > $this->totalRows) ? $this->totalRows : $this->lastRow;
    }
    ...
    public function show() {
        ...
        $page_str = str_replace(
            array('%HEADER%', '%NOW_PAGE%', '%UP_PAGE%', '%DOWN_PAGE%', '%FIRST%', '%LINK_PAGE%', '%END%', '%TOTAL_ROW%', '%TOTAL_PAGE%', '%FIRST_ROW%', '%LAST_ROW%'),
            array($this->config['header'], $this->nowPage, $up_page, $down_page, $the_first, $link_page, $the_end, $this->totalRows, $this->totalPages, $this->firstRowShow, $this->lastRow),
            $this->config['theme']);
