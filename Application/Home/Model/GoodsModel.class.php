...
class GoodsModel extends Model
{
    ...
    public function getPromote()
    {
        ...
        // 获得随机的商品ID
        for ($i = 1, $n = $promote_number * 3; $i <= $n; ++$i) {
// 3备容错
    ...
    public function getPrice($goods_id, $goods_product_id = 0, $member_id = 0)
    {
        ...
        //商品价格
        $goods_price = $this->where(['goods_id' => $goods_id])->getField('price');
        ...
        if ($goods_product_id != 0) {
            ...
            switch ($m_goods_product->price_operate) {
                case '=':
                    $real_price = $m_goods_product->product_price;
                    break;
